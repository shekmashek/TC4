                        ...
                        {overdueTransactions.length > 0 ? (
                            <ul className="space-y-2">
                                {overdueTransactions.map(tx => {
                                    ...
                                    const isPayable = tx.type === 'payable';
                                    const amountToDisplay = tx.original_amount != null ? tx.original_amount : tx.amount;
                                    const currencyToUse = tx.currency || currencySettingsForView.currency;
                                    const customCurrencySettings = { ...currencySettingsForView, currency: currencyToUse };
                                    return (
                                        <li key={tx.id}>
                                            <button
                                            ...
                                            >
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <p className="text-base font-normal whitespace-nowrap pl-2 text-gray-600">{formatCurrency(amountToDisplay, customCurrencySettings)}</p>
                                                </div>
                                            </button>
                                        </li>
                                    );
