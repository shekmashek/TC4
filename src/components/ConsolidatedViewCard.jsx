...
const ConsolidatedViewCard = ({ view }) => {
    ...
    return (
        <div 
            ...
            className="bg-white rounded-lg shadow-md border border-gray-200 p-5 flex flex-col justify-between hover:shadow-lg transition-shadow cursor-pointer"
        >
            <div>
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    {includedProjects.slice(0, 4).map(p => (
                        <div key={p.id} className="flex items-center gap-1.5 px-2 py-0.5 bg-gray-100 rounded-full text-xs text-gray-600" title={p.name}>
                            <Folder size={12} />
